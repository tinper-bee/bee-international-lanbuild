...
class Reference extends Component {
    constructor(props){
        ...
        this.commonColumns = [
            { title: 'noDictionnaryFlag', dataIndex: 'refcode', key: 'refcode' },
            { title: 'noDictionnaryFlag', dataIndex: 'refname', key: 'refname' },
            { title: 'noDictionnaryFlag', dataIndex: 'pk_eps', key: 'pk_eps', render: this.changeHeight.bind(this)},
            {
                title: 'noDictionnaryFlag', dataIndex: '', key: 'refpk', render: this.renderDelete.bind(this),
            },
        ...
        this.columns = [
            { title: 'noDictionnaryFlag', dataIndex: 'refcode', key: 'refcode' },
            { title: 'noDictionnaryFlag', dataIndex: 'refname', key: 'refname' },
            { title: 'noDictionnaryFlag', dataIndex: 'pk_eps', key: 'pk_eps'},
            {
                title: 'noDictionnaryFlag', dataIndex: '', key: 'refpk', render: this.renderAdd.bind(this),
            },
        ];
    ...
    renderAdd (text, record, index) {
        return <span style={{ cursor: 'pointer' }} onClick={this.handleAdd(record)}><Icon type="uf-plus" />noDictionnaryFlag</span>;
    }
    renderDelete (text, record, index) {
        return <Popconfirm content="noDictionnaryFlag" onClick={e=>e.stopPropagation()} onClose={this.handleDelete(index)}>
            <span>
            <Icon type="uf-del" />
            noDictionnaryFlag
            </span>
            ...
            <Row>
                ...
                <Modal show={ this.state.show } size='xlg' onHide={ this.close }>
                    <Modal.Header closeButton>
                        <Modal.Title > noDictionnaryFlag </Modal.Title>
                    </Modal.Header >
                    <Modal.Body >
                        <Tabs
                            defaultActiveKey="2"
                        ...
                        >
                            <TabPane tab="noDictionnaryFlag" key="1">
                                <Table
                            ...
                            <TabPane tab="noDictionnaryFlag" key="2">
                                <div>
                                    <Col md={3}>
                    ...
                    <Modal.Footer>
                        <div style={{ textAlign: 'left'}}>
                            <span style={{ padding: "5px 10px" }}>noDictionnaryFlag:</span>
                            <span>{
                        ...
                        <div>
                            <Button onClick={ this.empty }> noDictionnaryFlag </Button>
                            <Button onClick={ this.ensure } colors="primary" style={{ margin: "0 30px" }}> noDictionnaryFlag </Button>
                            <Button onClick={ this.close }> noDictionnaryFlag </Button>
                        </div>
