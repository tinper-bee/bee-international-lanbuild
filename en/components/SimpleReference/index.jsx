...
class SimpleReference extends Component {
    constructor(props){
        ...
        this.commonColumns = [
            { title: 'bank account', dataIndex: 'id', key: 'id'},
            {  title: 'bank name', dataIndex: 'refname', key: 'refname'},
            { title: 'account number', dataIndex: 'refpk', key: 'refpk'},
            {
                title: 'operation', dataIndex: '', key: 'd', render: this.renderAdd.bind(this),
            },
        ];
        this.columns = [
            { title: 'bank account', dataIndex: 'id', key: 'id'},
            ...
            { title: 'account number', dataIndex: 'refpk', key: 'refpk'},
            {
                title: 'operation', dataIndex: '', key: 'd', render: this.renderDelete.bind(this),
            },
        ];
    ...
    renderAdd (text, record, index) {
        return <span style={{ cursor: 'pointer' }} onClick={this.handleAdd(record)}><Icon type="uf-plus"></Icon>append to collect</span>;
    }
    renderDelete (text, record, index) {
        return <Popconfirm content="confirm delete?" onClick={e=>e.stopPropagation()} onClose={this.handleDelete(index)}>
            <span>
        ...
        return (
            <Row>
                <Col md={10} mdOffset={1}>
                    <FormGroup>
                        <Label>simple ref example</Label>
                        <FormControl
                ...
                <Modal show={ this.state.show } size='xlg' onHide={ this.close }>
                    <Modal.Header closeButton>
                        <Modal.Title > I'm header </Modal.Title>
                    </Modal.Header >
                    <Modal.Body >
                        <Tabs
                            defaultActiveKey="2"
                    ...
                    <Modal.Footer>
                        <Button onClick={ this.ensure } colors="primary" style={{ marginRight: 50 }}> ok </Button>
