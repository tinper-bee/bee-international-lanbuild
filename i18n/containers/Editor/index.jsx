    ...
    render() {
        return (
            <Row>
                ...
                <Button onClick={this._onInsertSoftNewLine.bind(this)}>$i18n{index.jsx0}$i18n-end</Button>
                <Button onClick={this.getCurrentBlockType.bind(this)}>$i18n{index.jsx1}$i18n-end</Button>
                <ColorControls
