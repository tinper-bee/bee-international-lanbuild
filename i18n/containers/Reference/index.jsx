...
class Reference extends Component {
    constructor(props){
        ...
        this.commonColumns = [
            { title: '$i18n{index.jsx0}$i18n-end', dataIndex: 'refcode', key: 'refcode' },
            { title: '$i18n{index.jsx1}$i18n-end', dataIndex: 'refname', key: 'refname' },
            { title: '$i18n{index.jsx2}$i18n-end', dataIndex: 'pk_eps', key: 'pk_eps', render: this.changeHeight.bind(this)},
            {
                title: '$i18n{index.jsx3}$i18n-end', dataIndex: '', key: 'refpk', render: this.renderDelete.bind(this),
            },

        ];
        this.columns = [
            { title: '$i18n{index.jsx4}$i18n-end', dataIndex: 'refcode', key: 'refcode' },
            { title: '$i18n{index.jsx5}$i18n-end', dataIndex: 'refname', key: 'refname' },
            { title: '$i18n{index.jsx6}$i18n-end', dataIndex: 'pk_eps', key: 'pk_eps'},
            {
                title: '$i18n{index.jsx7}$i18n-end', dataIndex: '', key: 'refpk', render: this.renderAdd.bind(this),
            },
        ];
    ...
    renderAdd (text, record, index) {
        return <span style={{ cursor: 'pointer' }} onClick={this.handleAdd(record)}><Icon type="uf-plus" />$i18n{index.jsx8}$i18n-end</span>;
    }
        ...
        return (
            <Row>
                <Col md={10} mdOffset={1}>
                    <FormGroup>
                        <Label>$i18n{index.jsx11}$i18n-end</Label>
                        <FormControl
                ...
                <Modal show={ this.state.show } size='xlg' onHide={ this.close }>
                    <Modal.Header closeButton>
                        <Modal.Title > $i18n{index.jsx12}$i18n-end </Modal.Title>
                    </Modal.Header >
                    <Modal.Body >
                        <Tabs
                            defaultActiveKey="2"
                        ...
                        >
                            <TabPane tab="$i18n{index.jsx13}$i18n-end" key="1">
                                <Table
                            ...
                            <TabPane tab="$i18n{index.jsx14}$i18n-end" key="2">
                                <div>
                                    <Col md={3}>
                    ...
                    <Modal.Footer>
                        <div style={{ textAlign: 'left'}}>
                            <span style={{ padding: "5px 10px" }}>$i18n{index.jsx15}$i18n-end:</span>
                            <span>{
                        ...
                        <div>
                            <Button onClick={ this.empty }> $i18n{index.jsx16}$i18n-end </Button>
                            <Button onClick={ this.ensure } colors="primary" style={{ margin: "0 30px" }}> $i18n{index.jsx17}$i18n-end </Button>
                            <Button onClick={ this.close }> $i18n{index.jsx18}$i18n-end </Button>
                        </div>
