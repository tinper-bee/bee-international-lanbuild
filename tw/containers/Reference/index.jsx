...
class Reference extends Component {
    constructor(props){
        ...
        this.commonColumns = [
            { title: '', dataIndex: 'refcode', key: 'refcode' },
            { title: '', dataIndex: 'refname', key: 'refname' },
            { title: '', dataIndex: 'pk_eps', key: 'pk_eps', render: this.changeHeight.bind(this)},
            {
                title: '', dataIndex: '', key: 'refpk', render: this.renderDelete.bind(this),
            },
        ...
        this.columns = [
            { title: '', dataIndex: 'refcode', key: 'refcode' },
            { title: '', dataIndex: 'refname', key: 'refname' },
            { title: '', dataIndex: 'pk_eps', key: 'pk_eps'},
            {
                title: '', dataIndex: '', key: 'refpk', render: this.renderAdd.bind(this),
            },
        ];
    ...
    renderAdd (text, record, index) {
        return <span style={{ cursor: 'pointer' }} onClick={this.handleAdd(record)}><Icon type="uf-plus" /></span>;
    }
                ...
                <Modal show={ this.state.show } size='xlg' onHide={ this.close }>
                    ...
                    <Modal.Footer>
                        ...
                        <div>
                            ...
                            <Button onClick={ this.ensure } colors="primary" style={{ margin: "0 30px" }}>  </Button>
